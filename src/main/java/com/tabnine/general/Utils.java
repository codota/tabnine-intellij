...
public final class Utils {
    ...
    public static void setCustomRepository(String url) {
        if (!url.trim().isEmpty()) {
            ...
            String newStore = String.format("%s/update/jetbrains/updatePlugins.xml", trimEndSlashAndWhitespace(url));
    ...
    public static void replaceCustomRepository(String oldUrl, String newUrl) {
        ...
        if (!newUrl.trim().isEmpty()) {
            String newStore = String.format("%s/update/jetbrains/updatePlugins.xml", trimEndSlashAndWhitespace(newUrl));
            pluginHosts.add(newStore);
            Logger.getInstance(Utils.class).debug(String.format("Added custom repository to %s", newStore));
        }
