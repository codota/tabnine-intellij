...
public final class InlineCompletionParameters {
    ...
    InlineCompletionParameters(@NotNull Editor editor, @NotNull Project project, @NotNull Document document, @NotNull String prefix, @NotNull CharSequence newFragment, int offset) {
        this.editor = editor;
