...
public class InlineHints {
    ...
    private final static HintManagerImpl hintManager = HintManagerImpl.getInstanceImpl();
    ...
    private static void initPreInsertionHint() {
        String nextShortcut = KeymapUtil.getFirstKeyboardShortcutText(ActionManager.getInstance().getAction(ShowNextInlineCompletionAction.ACTION_ID));
        String prevShortcut = KeymapUtil.getFirstKeyboardShortcutText(ActionManager.getInstance().getAction(ShowPreviousInlineCompletionAction.ACTION_ID));
        ...
        String text = "Next (" + nextShortcut + ") Prev (" + prevShortcut + ") Accept (" + acceptShortcut + ") Cancel (" + cancelShortcut + ")";
    ...
    private static JComponent createInlineHintComponent(String text) {
        ...
        SimpleColoredText coloredText = new SimpleColoredText(text, SimpleTextAttributes.REGULAR_ATTRIBUTES);
