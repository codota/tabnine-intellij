...
class Initializer : PreloadingActivity(), StartupActivity {
    private val binaryNotificationsLifecycle = DependencyContainer.instanceOfBinaryNotifications()
    private val binaryPromotionStatusBarLifecycle = DependencyContainer.instanceOfBinaryPromotionStatusBar()
