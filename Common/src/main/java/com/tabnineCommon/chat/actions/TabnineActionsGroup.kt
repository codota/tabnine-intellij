...
import com.tabnineCommon.chat.actions.toolWindowActions.ConversationsParentAction
...
class TabnineActionsGroup private constructor() : DefaultActionGroup("Tabnine Chat", false) {
    companion object {
        fun create(browser: ChatBrowser): TabnineActionsGroup {
            ...
            group.add(
                ConversationsParentAction(
                    browser,
                    listOf(
                        ClearConversationAction(browser),
                        NewConversationAction(browser),
                        ChatHistoryAction(browser)
                    )
                )
            )
