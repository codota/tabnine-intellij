...
import com.tabnineCommon.testUtils.TestData.* // ktlint-disable no-wildcard-imports
...
class LocalBinaryVersionsTests {
    ...
    fun `given active file with valid version then return version`() {
        ...
        assertThat(
            ...
            equalTo(Optional.of(com.tabnine.binary.fetch.BinaryVersion(PREFERRED_VERSION)))
        )
    }
}
